...
const FACT_PAGES = {
  ...
  "/office-counter": {
    eyebrow: "Office Counter · report 004",
    title: "EVIDENCE, NOT GROWTH THEATER.",
    intro: "A dated public snapshot of what is deployed, what was tested, what was published, and what remains unresolved. Counts below use a 2026-07-19 18:17 CST cutoff and are not live analytics.",
    sections: [
      ...
      ["Public evidence inventory", "32 evergreen mechanism, security, API-reference, education, WBNB, token-approval, slippage, constant-product AMM, liquidity, Opening, Creator-stake, contribution-identity, cancellation, excess-refund, permissionless-finalization, successful-claim, Failed-refund, Founder-sale, Still-Waiting, post-Rugged trading, lifecycle-template, Creator-readback, community-safety, and gate-review pages plus the TESTNET lifecycle archive and this dated Office Counter make 34 trust-first evidence routes public. The sitemap contains 37 URLs. Google Search Console accepted the refreshed sitemap on 2026-07-19 and its aggregate row reports 37 discovered pages with 0 videos. URL Inspection initially classified the new liquidity guide as unknown and not indexed, detected no referring sitemap or page, recorded no last crawl, and accepted a priority-crawl request. Its indexing report remains processing and the overview reports 0 web-search clicks. Discovery and notification requests do not prove indexing, ranking, clicks, visits, or use."],
      ...
      ["Review and directory state", "DappBay's latest owner-side My Project route rendered Page Not Found, its submit page requested a fresh wallet connection, and its public search returned No related dApps or campaigns; the earlier Security Reviewing state is not promoted to a current result. RootData's prior dashboard session expired, so its last authenticated Pending Review state was not promoted either. DappRadar's official submit link and Developers route redirect to its homepage, which exposes no submit entry. Focused public searches found no Rugspull detail page on those services, MathWallet, Magic Store, or Moralis Web3 Wiki. BNB Chain Awesome PR #13 and Electric Capital PR #2932 remain open and clean. GitHub Issue 1 now has four project-authored review comments and no external response. None of these states is an audit, listing approval, independent review, recommendation, partnership, or BNB Chain endorsement."],
      ["Deployment continuity record", "A prior README-only GitHub push exposed source drift and temporarily caused sampled edges to disagree. The deployment source was synchronized, and subsequent GitHub-triggered deployments restored consistent public assets. The current production sitemap serves 37 unique URLs, and the liquidity guide from commit 07859a1 renders with its canonical metadata and risk boundaries. This is a dated recovery and deployment observation, not an uptime SLA or future-availability promise."],
      ["Machine-readable discovery", "Mirrored root and well-known security.txt files, llms.txt, a ten-item RSS evidence feed, homepage RSS discovery, and the IndexNow key are public. The feed includes the WBNB, token-approval, slippage, constant-product AMM, and liquidity guides plus current discovery boundaries; llms.txt links all five transaction-preparation and mechanism explanations directly. IndexNow accepted 48 URLs: 37 sitemap URLs plus 11 machine-readable resources. Security contact, pending independent audit, total loss, organized-mainnet NO-GO, and no-inferred-endorsement boundaries are explicit. Publication and successful notification do not prove crawl, subscription, AI ingestion, response, indexing, or readership."],
