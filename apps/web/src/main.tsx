...
const FACT_PAGES = {
  ...
  "/office-counter": {
    ...
    sections: [
      ...
      ["Public evidence inventory", "28 evergreen mechanism, security, API-reference, education, WBNB, Opening, Creator-stake, contribution-identity, cancellation, excess-refund, permissionless-finalization, successful-claim, Failed-refund, Founder-sale, Still-Waiting, post-Rugged trading, lifecycle-template, Creator-readback, community-safety, and gate-review pages plus the TESTNET lifecycle archive and this dated Office Counter make 30 trust-first evidence routes public. The sitemap contains 33 URLs. Google Search Console accepted the refreshed sitemap on 2026-07-19 and its aggregate row reports 33 discovered pages with 0 videos. URL Inspection classifies the new WBNB guide as discovered but not indexed, detects the sitemap, records no referring page or last crawl, and accepted a priority-crawl request. Its indexing report remains processing and the overview reports 0 web-search clicks. Discovery and notification requests do not prove indexing, ranking, clicks, visits, or use."],
      ...
      ["Machine-readable discovery", "Mirrored root and well-known security.txt files, llms.txt, a seven-item RSS evidence feed, homepage RSS discovery, and the IndexNow key are public. The feed carries the current 33-page aggregate and WBNB URL-level discovery boundary plus the finalization, successful-claim, and WBNB guides; llms.txt links the WBNB explanation directly. Security contact, pending independent audit, total loss, organized-mainnet NO-GO, and no-inferred-endorsement boundaries are explicit. Publication and successful notification do not prove crawl, subscription, AI ingestion, response, indexing, or readership."],
