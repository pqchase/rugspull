...
const FACT_PAGES = {
  ...
  "/office-counter": {
    ...
    sections: [
      ...
      ["Machine-readable discovery", "Mirrored root and well-known security.txt files, llms.txt, a four-item RSS evidence feed, homepage RSS discovery, and the IndexNow key are public. Security contact, pending independent audit, total loss, organized-mainnet NO-GO, and no-inferred-endorsement boundaries are explicit. Publication and successful notification do not prove crawl, subscription, AI ingestion, response, indexing, or readership."],
