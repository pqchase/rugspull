...
const FACT_PAGES = {
  ...
  "/office-counter": {
    ...
    sections: [
      ...
      ["Public evidence inventory", "26 evergreen mechanism, security, API-reference, education, Opening, Creator-stake, contribution-identity, cancellation, excess-refund, permissionless-finalization, claim/refund, Founder-sale, Still-Waiting, post-Rugged trading, lifecycle-template, Creator-readback, community-safety, and gate-review pages plus the TESTNET lifecycle archive and this dated Office Counter make 28 trust-first evidence routes public. The sitemap contains 31 URLs. Google Search Console accepted the refreshed sitemap on 2026-07-19 and reports all 31 URLs discovered with 0 videos; its indexing report remains processing and the overview reports 0 web-search clicks. URL Inspection classifies the new permissionless-finalization guide as discovered but not indexed, detects the sitemap, records no last crawl, and confirms that a priority-crawl request was accepted. Aggregate sitemap discovery and accepted requests do not prove indexing, ranking, clicks, visits, or use."],
