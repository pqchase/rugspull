...
const FACT_PAGES = {
  ...
  "/office-counter": {
    ...
    sections: [
      ...
      ["Public evidence inventory", "31 evergreen mechanism, security, API-reference, education, WBNB, token-approval, slippage, constant-product AMM, Opening, Creator-stake, contribution-identity, cancellation, excess-refund, permissionless-finalization, successful-claim, Failed-refund, Founder-sale, Still-Waiting, post-Rugged trading, lifecycle-template, Creator-readback, community-safety, and gate-review pages plus the TESTNET lifecycle archive and this dated Office Counter make 33 trust-first evidence routes public. The sitemap contains 36 URLs. Google Search Console's latest confirmed aggregate remains 35 discovered pages with 0 videos; the new constant-product AMM guide has not yet been confirmed there. The latest inspected slippage guide is discovered but not indexed, its sitemap is detected, no referring page or last crawl is recorded, and a priority-crawl request was accepted. Its indexing report remains processing and the overview reports 0 web-search clicks. Discovery and notification requests do not prove indexing, ranking, clicks, visits, or use."],
      ...
      ["Machine-readable discovery", "Mirrored root and well-known security.txt files, llms.txt, a ten-item RSS evidence feed, homepage RSS discovery, and the IndexNow key are public. The feed includes the WBNB, token-approval, slippage, and constant-product AMM guides plus current discovery boundaries; llms.txt links all four transaction-preparation and mechanism explanations directly. Security contact, pending independent audit, total loss, organized-mainnet NO-GO, and no-inferred-endorsement boundaries are explicit. Publication and successful notification do not prove crawl, subscription, AI ingestion, response, indexing, or readership."],
