...
const FACT_PAGES = {
  ...
  "/office-counter": {
    eyebrow: "Office Counter · report 005",
    title: "EVIDENCE, NOT GROWTH THEATER.",
    intro: "A dated public snapshot of what is deployed, what was tested, what was published, and what remains unresolved. Counts below use a 2026-07-19 18:38 CST cutoff and are not live analytics.",
    sections: [
      ...
      ["Public evidence inventory", "33 evergreen mechanism, security, API-reference, education, WBNB, token-approval, slippage, constant-product AMM, liquidity, BscScan reserve-verification, Opening, Creator-stake, contribution-identity, cancellation, excess-refund, permissionless-finalization, successful-claim, Failed-refund, Founder-sale, Still-Waiting, post-Rugged trading, lifecycle-template, Creator-readback, community-safety, and gate-review pages plus the TESTNET lifecycle archive and this dated Office Counter make 35 trust-first evidence routes public. The sitemap contains 38 URLs. Google Search Console accepted the refreshed sitemap on 2026-07-19 and its aggregate row reports 38 discovered pages with 0 videos. URL Inspection classified the new reserve-verification guide as not indexed: discovered but not indexed, detected the submitted sitemap, detected no referring page, recorded no last crawl, and accepted a priority-crawl request. Its indexing report remains processing and the overview reports 0 web-search clicks. Discovery and notification requests do not prove indexing, ranking, clicks, visits, or use."],
      ...
      ["Deployment continuity record", "A prior README-only GitHub push exposed source drift and temporarily caused sampled edges to disagree. The deployment source was synchronized, and subsequent GitHub-triggered deployments restored consistent public assets. The current production sitemap serves 38 unique URLs, and the BscScan reserve-verification guide from commit 63138d9 renders with its canonical metadata, ten evidence steps, and risk boundaries. This is a dated recovery and deployment observation, not an uptime SLA or future-availability promise."],
      ["Machine-readable discovery", "Mirrored root and well-known security.txt files, llms.txt, a ten-item RSS evidence feed, homepage RSS discovery, the IndexNow key, and a source-controlled IndexNow submission command are public. The feed and llms.txt link the WBNB, token-approval, slippage, constant-product AMM, liquidity, and reserve-verification guides directly. IndexNow accepted 49 URLs: 38 sitemap URLs plus 11 machine-readable resources. Security contact, pending independent audit, total loss, organized-mainnet NO-GO, and no-inferred-endorsement boundaries are explicit. Publication and successful notification do not prove crawl, subscription, AI ingestion, response, indexing, or readership."],
