...
const FACT_PAGES = {
  ...
  "/office-counter": {
    eyebrow: "Office Counter · report 023",
    title: "EVIDENCE, NOT GROWTH THEATER.",
    intro: "A dated public snapshot of what is deployed, what was tested, what was published, and what remains unresolved. Counts below use a 2026-07-19 22:43 CST cutoff and are not live analytics.",
    sections: [
      ...
      ["Public evidence inventory", "51 evergreen mechanism, security, API-reference, education, WBNB, token-approval, slippage, constant-product AMM, liquidity, BscScan reserve-verification, MEV, alternative-pool, smart-contract-invariant, token-conservation, WBNB-conservation, no-double-claim, no-double-rug, reserve-reconciliation, Founder-Token-immobility, protocol-fee-destination, non-decreasing-AMM-k, lifecycle-status-monotonicity, economic-allocation-consistency, Opening-versus-initial-pool-price, pro-rata-claim-rounding, claim-and-refund-settlement, verified-source/audit-boundary, D1/financial-truth, Opening, Creator-stake, contribution-identity, cancellation, excess-refund, permissionless-finalization, successful-claim, Failed-refund, Founder-sale, Still-Waiting, post-Rugged trading, lifecycle-template, Creator-readback, community-safety, and gate-review pages plus the TESTNET lifecycle archive and this dated Office Counter make 53 trust-first evidence routes public. The sitemap contains 56 URLs. Google Search Console accepted the refreshed sitemap on 2026-07-19 and its aggregate row reports 56 discovered pages with 0 videos. URL Inspection classified the new claim-and-refund-settlement guide as not indexed because Google could not recognize the URL and detected no referring sitemap or referring page; a priority indexing request was initiated. The overview reports 0 web-search clicks. Discovery and notification requests do not prove indexing, ranking, clicks, visits, or use."],
