...
const FACT_PAGES = {
  ...
  "/office-counter": {
    eyebrow: "Office Counter · report 003",
    title: "EVIDENCE, NOT GROWTH THEATER.",
    intro: "A dated public snapshot of what is deployed, what was tested, what was published, and what remains unresolved. Counts below use a 2026-07-19 11:21 CST cutoff and are not live analytics.",
    sections: [
      ...
      ["Public evidence inventory", "30 evergreen mechanism, security, API-reference, education, WBNB, token-approval, slippage, Opening, Creator-stake, contribution-identity, cancellation, excess-refund, permissionless-finalization, successful-claim, Failed-refund, Founder-sale, Still-Waiting, post-Rugged trading, lifecycle-template, Creator-readback, community-safety, and gate-review pages plus the TESTNET lifecycle archive and this dated Office Counter make 32 trust-first evidence routes public. The sitemap contains 35 URLs. Google Search Console's latest confirmed aggregate remains 34 discovered pages with 0 videos; the new slippage guide has not yet been confirmed there. The latest inspected token-approval guide is discovered but not indexed, its sitemap is detected, no referring page or last crawl is recorded, and a priority-crawl request was accepted. Its indexing report remains processing and the overview reports 0 web-search clicks. Discovery and notification requests do not prove indexing, ranking, clicks, visits, or use."],
      ...
      ["Machine-readable discovery", "Mirrored root and well-known security.txt files, llms.txt, a nine-item RSS evidence feed, homepage RSS discovery, and the IndexNow key are public. The feed includes the WBNB, token-approval, and slippage guides plus current discovery boundaries; llms.txt links all three transaction-preparation explanations directly. Security contact, pending independent audit, total loss, organized-mainnet NO-GO, and no-inferred-endorsement boundaries are explicit. Publication and successful notification do not prove crawl, subscription, AI ingestion, response, indexing, or readership."],
