...
const FACT_PAGES = {
  ...
  "/office-counter": {
    ...
    sections: [
      ...
      ["Public evidence inventory", "27 evergreen mechanism, security, API-reference, education, Opening, Creator-stake, contribution-identity, cancellation, excess-refund, permissionless-finalization, successful-claim, Failed-refund, Founder-sale, Still-Waiting, post-Rugged trading, lifecycle-template, Creator-readback, community-safety, and gate-review pages plus the TESTNET lifecycle archive and this dated Office Counter make 29 trust-first evidence routes public. The sitemap contains 32 URLs. Google Search Console accepted the refreshed sitemap on 2026-07-19 and its sitemap row reports 32 discovered pages with 0 videos; its indexing report remains processing and the overview reports 0 web-search clicks. URL Inspection still classifies the new Opening-claim guide as unknown to Google, detects no referring sitemap, records no last crawl, and confirms that a priority-crawl request was accepted. The aggregate sitemap count and URL-level state can propagate at different times; neither proves indexing, ranking, clicks, visits, or use."],
      ...
      ["Machine-readable discovery", "Mirrored root and well-known security.txt files, llms.txt, a six-item RSS evidence feed, homepage RSS discovery, and the IndexNow key are public. The feed carries the current aggregate-versus-URL discovery boundary plus the finalization and successful-claim guides. Security contact, pending independent audit, total loss, organized-mainnet NO-GO, and no-inferred-endorsement boundaries are explicit. Publication and successful notification do not prove crawl, subscription, AI ingestion, response, indexing, or readership."],
