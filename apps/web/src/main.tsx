...
const FACT_PAGES = {
  ...
  "/office-counter": {
    ...
    sections: [
      ...
      ["Public evidence inventory", "30 evergreen mechanism, security, API-reference, education, WBNB, token-approval, slippage, Opening, Creator-stake, contribution-identity, cancellation, excess-refund, permissionless-finalization, successful-claim, Failed-refund, Founder-sale, Still-Waiting, post-Rugged trading, lifecycle-template, Creator-readback, community-safety, and gate-review pages plus the TESTNET lifecycle archive and this dated Office Counter make 32 trust-first evidence routes public. The sitemap contains 35 URLs. Google Search Console accepted the refreshed sitemap on 2026-07-19 and its aggregate row reports 35 discovered pages with 0 videos. URL Inspection classifies the new slippage guide as discovered but not indexed, detects the sitemap, records no referring page or last crawl, and accepted a priority-crawl request. Its indexing report remains processing and the overview reports 0 web-search clicks. Discovery and notification requests do not prove indexing, ranking, clicks, visits, or use."],
