...
function socialImageForPath(pathname: string) {
  ...
  if (pathname.startsWith("/security-model") || pathname.startsWith("/api-reference") || pathname.startsWith("/transparency") || pathname.startsWith("/contracts") || pathname.startsWith("/how-to-check-a-smart-contract-on-bscscan") || pathname.startsWith("/what-are-smart-contract-invariants") || pathname.startsWith("/what-does-token-conservation-mean") || pathname.startsWith("/what-does-wbnb-conservation-mean") || pathname.startsWith("/what-does-no-double-claim-mean") || pathname.startsWith("/what-does-no-double-rug-mean") || pathname.startsWith("/what-does-reserve-reconciliation-mean") || pathname.startsWith("/what-does-founder-token-immobility-mean") || pathname.startsWith("/what-does-protocol-fee-destination-mean") || pathname.startsWith("/what-does-non-decreasing-amm-k-mean") || pathname.startsWith("/verified-source-code-does-not-mean-audited") || pathname.startsWith("/why-d1-is-not-financial-truth") || pathname.startsWith("/rugpool-vs-pancakeswap") || pathname.startsWith("/failed-opening-refund-guide") || pathname.startsWith("/what-if-founder-never-rugs") || pathname.startsWith("/office-counter") || pathname.startsWith("/lifecycle-templates") || pathname.startsWith("/creator-handbook") || pathname.startsWith("/community-safety") || pathname.startsWith("/stage-0-review")) {
