...
const FACT_PAGES = {
  ...
  "/office-counter": {
    eyebrow: "Office Counter · report 011",
    title: "EVIDENCE, NOT GROWTH THEATER.",
    intro: "A dated public snapshot of what is deployed, what was tested, what was published, and what remains unresolved. Counts below use a 2026-07-19 19:59 CST cutoff and are not live analytics.",
    sections: [
      ...
      ["Public evidence inventory", "39 evergreen mechanism, security, API-reference, education, WBNB, token-approval, slippage, constant-product AMM, liquidity, BscScan reserve-verification, MEV, alternative-pool, smart-contract-invariant, token-conservation, verified-source/audit-boundary, D1/financial-truth, Opening, Creator-stake, contribution-identity, cancellation, excess-refund, permissionless-finalization, successful-claim, Failed-refund, Founder-sale, Still-Waiting, post-Rugged trading, lifecycle-template, Creator-readback, community-safety, and gate-review pages plus the TESTNET lifecycle archive and this dated Office Counter make 41 trust-first evidence routes public. The sitemap contains 44 URLs. Google Search Console accepted the refreshed sitemap on 2026-07-19 and its aggregate row reports 44 discovered pages with 0 videos. URL Inspection classified the new token-conservation guide as not indexed because Google could not recognize the URL, detected no referring sitemap or referring page, recorded no last crawl, and accepted a priority indexing request. The overview reports 0 web-search clicks. Discovery and notification requests do not prove indexing, ranking, clicks, visits, or use."],
